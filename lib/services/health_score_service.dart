...
class HealthScoreService {
  ...
  static Map<String, dynamic> calculateMachineHealth(String machineId) {
    ...
    final productivityPercentage =
        totalCompleted > 0 ? (completedOnTime / totalCompleted) * 100 : 100.0;
  ...
  static Map<String, dynamic> calculateShiftSummary() {
    ...
    final shiftScrapRate =
        totalProduced > 0 ? (totalScrap / totalProduced) * 100 : 0.0;
