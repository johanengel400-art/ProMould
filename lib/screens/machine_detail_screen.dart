...
class _MachineDetailScreenState extends State<MachineDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final runningJob = jobs.isNotEmpty &&
            JobStatus.isActivelyRunning(jobs.first['status'] as String?)
        ? jobs.first
        : null;
          ...
          SliverAppBar(
              ...
              background: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      _statusColor('${machine['status'] ?? 'Idle'}')
                          .withOpacity(0.3),
            ...
            actions: [
              PopupMenuButton<String>(
                ...
                itemBuilder: (context) => [
                  const PopupMenuItem(
                      value: 'Running', child: Text('Set Running')),
                  const PopupMenuItem(value: 'Idle', child: Text('Set Idle')),
                  const PopupMenuItem(
                      value: 'Breakdown', child: Text('Set Breakdown')),
                  const PopupMenuItem(
                      value: 'Changeover', child: Text('Set Changeover')),
                ],
              ),
            ],
          ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Tonnage: ${machine['tonnage'] ?? 'N/A'}',
                              style: const TextStyle(
                                  fontSize: 14, color: Colors.white70)),
                          const SizedBox(height: 4),
                          Text('Floor: ${machine['floorId'] ?? 'N/A'}',
                              style: const TextStyle(
                                  fontSize: 14, color: Colors.white70)),
                        ],
                      ),
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                              ...
                              builder: (context) {
                                ...
                                final target =
                                    (runningJob['targetShots'] as num? ?? 1)
                                        .toInt();
                                final overrun =
                                    completed > target ? completed - target : 0;
                            ...
                            Text(_calculateETA(runningJob, DateTime.now()),
                                style: const TextStyle(
