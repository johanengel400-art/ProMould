          ...
          Expanded(
            child: GridView.builder(
                ...
                itemBuilder: (_, i) {
                  ...
                  final progress =
                      target > 0 ? (shots / target).clamp(0.0, 1.0) : 0.0;
                  final progress100 = (progress * 100).round();

                  // Calculate scrap rate for this machine
                  final scrapData =
                      ScrapRateService.calculateMachineScrapRate(mId);
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                              colors: [
                                statusColor((m['status'] ?? 'Idle') as String)
                                    .withOpacity(0.14),
                      ...
                      child: Column(
                          ...
                          children: [
                            Row(children: [
                              ...
                              const Spacer(),
                              Chip(
                                  label: Text('${m['status'] ?? 'Idle'}'),
                                  backgroundColor:
                                      statusColor('${m['status'] ?? 'Idle'}')
                                          .withOpacity(0.18),
                                  shape: StadiumBorder(
                                      side: BorderSide(
                                          color: statusColor(
