...
class ManageMachinesScreen extends StatefulWidget {
  final int level;
  const ManageMachinesScreen({super.key, required this.level});
  @override
...
class _ManageMachinesScreenState extends State<ManageMachinesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final floors = {
      for (final f in floorsBox.values.cast<Map>()) f['id']: f['name']
    };
