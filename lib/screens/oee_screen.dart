...
class OEEScreen extends StatelessWidget {
  final int level;
  const OEEScreen({super.key, required this.level});
  ...
  Widget build(BuildContext context) {
    ...
    final downMins =
        downtime.fold<int>(0, (p, e) => p + (e?['minutes'] as int? ?? 0));
    ...
    final performance =
        targetShots > 0 ? (good / targetShots).clamp(0.0, 1.0) : 0.0;
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                            child: metricCard('Availability', availability,
                                Icons.access_time)),
                    ...
                    Row(
                      children: [
                        Expanded(
                            child:
                                metricCard('Quality', quality, Icons.verified)),
                        const SizedBox(width: 12),
