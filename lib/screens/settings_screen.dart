  ...
  Future<void> _resetDB(BuildContext context) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('This will delete all local data including:\n'
            '• Users (except admin)\n'
            '• Machines\n'
            '• Jobs\n'
            '• Moulds\n'
                      ...
                      ListTile(
                        ...
                        title: const Text('Reset Local Database',
                            style: TextStyle(
                                ...
                                fontWeight: FontWeight.bold)),
                        subtitle: const Text(
                            'Clears all local data and recreates admin user',
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        title: const Text('ProMould v8.0',
                            style: TextStyle(
                                color: Colors.white,
                                fontWeight: FontWeight.bold)),
                        subtitle: const Text('Smart Factory Management System',
                            style: TextStyle(color: Colors.white70)),
                      ),
                      const Divider(height: 1, color: Colors.white12),
                      const ListTile(
                        ...
                        leading:
                            Icon(Icons.code_outlined, color: Color(0xFF4CC9F0)),
